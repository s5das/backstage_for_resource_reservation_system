      ...
      <div class="content">
        <div class="head">
          <div style="display: flex; align-items: center;">
           ...
           <strong style="margin-bottom: 0">&nbsp;&nbsp;&nbsp;删除确认</strong>
          </div>
        ...
        <div class="bottom" > 
                ...
                size="default"
                @click="emits('close')"  
                style=" margin-left: 5px; width: 93.8px; height: 40.2px;"
                >取消</el-button
              >
                   <el-button
              type="danger" 
...
<script setup>
  import { CloseBold, Picture as IconPicture } from "@element-plus/icons-vue";
   import {removeAdmin} from "../http/api/memberManage";
  const emits = defineEmits(["close"]);
 const props = defineProps(["id"]);

  const deleteItem = () => {
    removeAdmin(props.id)
    .then(()=>{
      ElMessage({
        type: "success",
        message: "操作成功",
