<template>
  ...
  <Showdetail  :status="1" v-if="isshow" @close="isshow=false" @refresh="getinfo" :id="orderId" :meetingRoomId="meetingRoomId" :showsave="true" :showpass="false" :showreject="false" />
